$(document).ready(function() {
    ...
    var possibleWords = ['Macaw','Iguana','Sea Lion', 'Narwhal', 'Orangutan', 'Plains Bison', 'Sea Turtle', 'Saola', 'Sumatran Elephant', 'Sunda Tiger', 'Whale',
    ...
    function checkForLetter(letter) {
        ...
        correctSound.setAttribute("src", "assets/yes.mp3")
        incorrectSound.setAttribute("src","assets/no.mp3")
